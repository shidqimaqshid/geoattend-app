  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-2xl p-6 animate-fade-in-up max-h-[90vh] overflow-y-auto no-scrollbar">
        <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6">Edit Profil</h2>
        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-[10px] text-gray-500 mt-1 dark:text-gray-400">Biarkan kosong jika tidak ingin mengubah.</p>
            </div>
        </div>
